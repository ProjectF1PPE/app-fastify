...
// Version : 2021.10
// Nécessite Bootstrap 5.0 et sa bibliothèques d'icônes + composant noty et animate.css
// Date mise à jour : 24/12/2021
...
// ------------------------------------------------------------
    ...
    /**
     * Demande de confirmation avant de lancer la fonction supprimer() du script courant
     * @param {int} id
     */
    static confirmerSuppression(id) {
        let n = new Noty({
...
// ------------------------------------------------------------
    ...
    /**
     * Contrôle la valeur d'un champ et afficher un message d'erreur sous le champ
    ...
    /**
     * Contrôle la valeur d'un champ et intègre un icône vert ou rouge en image de fond du champ pour indiquer la validité du champ
    ...
    static fichierValide(file, controle) {
        controle.reponse = '';
        // vérification qu'un fichier est transmis
        if (file === undefined) {
            controle.reponse = 'Aucun fichier transmis'
            return false;
        }
        // si la taille a ne pas dépasser est précisée on controle la taille du fichier
        if (controle.taille && file.size > controle.taille) {
            controle.reponse = "La taille du fichier dépasse la taille autorisée";
            return false;
        ...
        if (controle.lesExtensions) {
            ...
            if (controle.lesExtensions.indexOf(extension) === -1) {
                controle.reponse = "Extension non acceptée";
                return false;
            }
        }
        return true;
